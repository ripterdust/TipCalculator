...
export const Options = () => {
    ...
    return <>
           <div className="inputs bill">
                ...
                <div className="">
                    <input type="text" name="bill" value={data.bill} onChange={hanldeInput} />
                    <DollarSvg />
                </div>
            </div>
            <Tip />
            <div className="inputs people">
                ...
                <div className="">
                    <input type="text" name='people' value={data.people} onChange={hanldeInput} />
